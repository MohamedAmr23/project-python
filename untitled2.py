...
#creat da cursor and initialize

mybd=sqlite3.connect("applicaion.db")
my_cursor= mybd.cursor()

# my_cursor.execute("CREATE DATABASE Buy")
my_cursor.execute("create table if not exists products(id integer ,prod text,amount integer )")
    
# ADD #
mybd.commit()
my_cursor.execute(f"insert into products (id ,prod,amount  )VALUES (1,'Classic',20) ")
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (2,"Classic_Joe_Tee",20) """)
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (3,"Hand_Grip",20) """)
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (4,"Drawstrin",20) """)
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (5,"Gloves",20) """)
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (6,"Commandos",20) """)
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (7,"SportQ",20) """)
my_cursor.execute("""INSERT INTO products (id ,prod,amount  )VALUES (8,"Optimum",20) """)

def decrease_value(n):
    mybd=sqlite3.connect("appli.dp")
    mybd.execute(
        f" UPDATE  products SET amount= amount - 1 WHERE id = {n}")
    mybd.close()
  ########################################################## row=1  column=1  
